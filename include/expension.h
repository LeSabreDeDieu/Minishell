...
/*   Updated: 2024/10/04 16:12:19 by sgabsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_realloc_and_split(t_stack *stack, t_ast_value *value, int i);
...
void	add_file_wildcard(t_stack **stack, char *pattern, struct dirent *entry,
			char *repo);
